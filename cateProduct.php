...
$P="SELECT `pro_id`, `pro_name`, `pro_price`, `pro_category`, `pro_image`, `pro_MaxQuntity`, `pro_description` FROM `products` WHERE pro_category = '$cateId'";
...
<div class="row" style="width: 80%; height: 800px; margin-left: 20%;">
	<center><h2>Categoried Products</h2></center>
